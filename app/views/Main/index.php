                ...
                <div class="col-md-3 product-left">
                    <div class="product-main simpleCart_shelfItem">
                        ...
                        <div class="product-bottom">
                            ...
                            <p>Explore Now</p>
                            <h4>
                                <a class="add-to-cart-link" href="cart/add?id=<?=$hit->id;?>" data-id="<?=$hit->id?>"><i></i></a> <span class=" item_price"><?=$curr['symbol_left'];?><?=$hit->price * $curr['value'];?><?=$curr['symbol_right'];?></span>
